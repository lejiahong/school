...
<header class="main-header">
    <a href="<?=Yii::$app->homeUrl?>" class="logo"><span class="logo-mini">后台</span><span class="logo-lg">后台管理系统</span></a>
        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="http://zuohao.oss-cn-hangzhou.aliyuncs.com/back/hb-logo.png?r=g&s=64" class="user-image"/>
