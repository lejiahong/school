...
<div class="news">
    <div class="center">
        ...
        <ul class="news-bar clearfix">
            <li><a class="active">重点新闻</a></li>
            <li><a href="<?php echo \yii\helpers\Url::toRoute(['news/information']);?>">创业资讯</a></li>
            <li><a href="<?php echo \yii\helpers\Url::toRoute(['news/information']);?>">浙文速递</a></li>
        </ul>
...
<script >
    ...
    function Load() {
        $.ajax({
            type: "GET",
            url: "<?= \yii\helpers\Url::toRoute(['news_load']);?>",
            data: {page: counters},
            dataType: "json",
            success: function (data) {
                ...
                for (i in data) {
                    ...
                    result += ' &id='+aid+'">';';
                    result += ' <div class="news_img"><img src="' + data[i]['fronFiles']['host'] + "/" + data[i]['fronFiles']['name'] + '"></div>';
                    ...
                    result += ' <div class="clearfix"></div><div class="info-content">'+ data[i]['content'] +'</div>';
                    result += ' </div></div>';
                    result += '  </a></li>';
