...
use getpu\tree\models\ActiveForm;
use getpu\tree\Module;
...
<div class="kv-detail-heading">
    <?php if (empty($inputOpts['disabled']) || ($isAdmin && $showFormButtons)): ?>
        <div class="pull-right">
            <button type="reset" class="btn btn-default" title="<?= Yii::t('tree', 'Reset') ?>">
                <i class="glyphicon glyphicon-repeat"></i>
            </button>
            <button type="submit" class="btn btn-primary" title="<?= Yii::t('tree', 'Save') ?>">
...
<?php else: ?>
    <div class="row">
        <div class="col-sm-6">
            ...
            <?= $form->field($node, $nameAttribute)->textInput($inputOpts) ?>
            <?= $form->field($node, $urlAttribute)->textInput($inputOpts) ?>
        </div>
        <div class="col-sm-6">
...
?>
<?php if ($isAdmin): ?>
    <h4><?= Yii::t('tree', 'Admin Settings') ?></h4>
