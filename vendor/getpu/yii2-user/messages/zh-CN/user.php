...
return [
    ...
    'Account details' => '用户信息',
    'Account details have been updated' => '用户信息成功更新',
    'An email has been sent with instructions for resetting your password' => '重置密码发送到您的邮箱请注意查收。',
    ...
    'Confirmation status' => '确认时间',
    'Confirmation time' => '',
    'Create' => '创建',
    'Create user' => '新建用户',
    'Credentials will be sent to the user by email' => '注册信息会发送至您的邮箱',
    'Delete' => '删除',
    ...
    'Not blocked' => '已解锁',
    'Permissions' => '权限',
    'Profile details' => '用户资料',
    'Profile details have been updated' => '用户资料更新成功',
    ...
    'Yandex' => '',
    'You can assign multiple roles or permissions to user by using the form below' => '您可以根据下面的表单分配更多的角色或权限',
