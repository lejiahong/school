...
class Select2 extends InputWidget
{
    ...
    protected function renderToggleAll()
    {
        ...
        $settings = array_replace_recursive([
            'selectLabel' => '<i class="glyphicon glyphicon-unchecked"></i>' . Yii::t('select2', 'Select all'),
            'unselectLabel' => '<i class="glyphicon glyphicon-check"></i>' . Yii::t('select2', 'Unselect all'),
            'selectOptions' => [],
            'unselectOptions' => [],
