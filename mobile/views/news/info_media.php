...
<div class="news">
    <div class="center">
        ...
        <ul class="news-bar clearfix">
            <li><a href="<?php echo \yii\helpers\Url::toRoute(['news/info']);?>">干货速递</a></li>
            <li><a href="<?php echo \yii\helpers\Url::toRoute(['news/media']);?>" class="active">合作媒体</a></li>
        </ul>
...
<script >
    ...
    function Load() {
        $.ajax({
            type: "GET",
            url: "<?= \yii\helpers\Url::toRoute(['media_load']);?>",
            data: {page: counters},
            dataType: "json",
