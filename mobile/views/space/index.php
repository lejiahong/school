    ...
    <div class="center">
        ...
        <div class="news-list clearfix">
            <ul class="news-bar clearfix">
                <li><a href="<?php echo \yii\helpers\Url::toRoute(['space/index']);?>" class="active">基本介绍</a></li>
                <li><a href="<?php echo \yii\helpers\Url::toRoute(['space/first_notice']);?>" >最新公告</a></li>
                <li><a href="<?php echo \yii\helpers\Url::toRoute(['space/first_down']);?>" >文件下载</a></li>
            </ul>
            <div>
                <div class="news-menu">
                    <div class="basic-intro">
                        <h3>元空间，也许是第一个校园全套服务众创空间</h3>
