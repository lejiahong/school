...
use getpu\user\Finder;
use getpu\user\models\RecoveryForm;
use getpu\user\models\Token;
use getpu\user\traits\AjaxValidationTrait;
use getpu\user\traits\EventTrait;
 ...
 *
 * @property \getpu\user\Module $module
 *
...
class RecoveryController extends Controller
{
     ...
     * Triggered with \getpu\user\events\FormEvent.
     */
     ...
     * Triggered with \getpu\user\events\ResetPasswordEvent. May not have $form property set.
     */
     ...
     * Triggered with \getpu\user\events\ResetPasswordEvent.
     */
